...
def main():
    ...
    cards = [
        ...
        ("8-instagram", card_panel("quite-for-instagram",
            ["A feed of the people", "you actually follow."],
            ["Adverts and the suggested posts from accounts you",
             "never followed, taken out. Free on the Web Store."])),
